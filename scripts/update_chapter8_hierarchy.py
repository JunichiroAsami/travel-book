...
def update_chapter8_hierarchy(input_file, output_file):
    ...
    for i, line in enumerate(lines):
        ...
        if line == '## この章の位置づけ':
            ...
            current_subsection = 0
            current_subsubsection = 0
            updated_lines.append(f'## 8.{current_section}. この章の位置づけ')
            continue
        ...
        if line == '## 章の導入部':
            ...
            current_subsection = 0
            current_subsubsection = 0
            updated_lines.append(f'## 8.{current_section}. 章の導入部')
            continue
            ...
            if match:
                ...
                if trouble_num in trouble_to_section:
                    ...
                    if section != current_section:
                        ...
                        if section == 1:
                            updated_lines.append(f'## 8.1. 現地でのトラブル対応')
                            updated_lines.append('')
                        elif section == 2:
                            updated_lines.append(f'## 8.2. 帰国後のトラブル対応')
                            updated_lines.append('')
